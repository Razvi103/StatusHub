...
function PopUpContainer({ children, close, className } : PopUpContainerProps) {

    return (
        <>
            <div className={"pop-up-container" + className}>
                <svg className='close-popup-btn' onClick={() => close()} width="24" height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
